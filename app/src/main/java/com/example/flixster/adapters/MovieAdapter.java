...
public class MovieAdapter extends RecyclerView.Adapter<MovieAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        // changed relativelayout id name to container
        RelativeLayout container;

        // Member Variables for Textview and Imageview
        TextView tvTitle;
        TextView tvOverview;
        ImageView ivPoster;
        ...
        public void bind(Movie movie) {
            ...
            String imageUrl;
            // If phone is in landscape, imageURL= back drop image, else = poster image
